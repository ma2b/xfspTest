...
/* 文本合成 */
int text_to_speech(const char* src_text, const char* des_path, const char *session_begin_params)
{
	int          ret          = -1;
	FILE*        fp           = NULL;
...
int ttsLogin(const char* login_params )
{
	int         ret                  = MSP_SUCCESS;
	/*
	* rdn:           合成音频数字发音方式
...
int main(int argc, char* argv[])
{
	...
	*/
	...
	/* 用户登录 */
	ret = ttsLogin("appid = 58723fb7, work_dir = .");
	if (MSP_SUCCESS != ret)
	{
